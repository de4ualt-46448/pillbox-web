...
INSERT INTO "new_Medication" ("dosage", "frequencyRaw", "id", "lowStockThreshold", "name", "pillsRemaining", "quantityPerDose", "timesOfDay", "totalQuantity", "userId", "voiceProfileId") SELECT "dosage", "frequencyRaw", "id", "lowStockThreshold", "name", "pillsRemaining", "quantityPerDose", "timesOfDay", "totalQuantity", "userId", "voiceProfileId" FROM "Medication";
...
INSERT INTO "new_VoiceProfile" ("audioPath", "createdAt", "displayName", "engine", "id", "isDefault", "localeTag", "remoteVoiceId", "userId") SELECT "audioPath", "createdAt", "displayName", "engine", "id", "isDefault", "localeTag", "remoteVoiceId", "userId" FROM "VoiceProfile";
...
-- CreateIndex
CREATE INDEX "DoseLog_takenAt_idx" ON "DoseLog"("takenAt");
